...
<html lang="th">
  ...
  <head>
    ...
    <link ... rel="stylesheet" type="text/css" href="css/index-iTravel.css?v=1010">
  ...
  <body>
      <?php include '../php/connectdb.php';
       ...
       ?>
        ...
        <nav class="navbar navbar-expand-lg nav-bg-ishop sticky-top">
          <div class="nav-menu-left">
             <a class="navbar-brand js-scroll-trigger text-white" href="../iTravel"><h4><strong>iKingdom iTravel</strong></h4></a>
           </div>
                  ...
                  <div class="nav-menu-right">
                    <div class="collapse navbar-collapse" id="navbarResponsive">
                      ...
                      <div class="dropdown-menu dropdown-menu-right">
                        <?php include '../community/php/menu_myshop.php'; ?>
              ...
              <center>
                <img src="../img/coming.jpg" class="coming-soon"><br>
                <button type="button" class="btn colro-ishop" onclick="window.location='../community'">กลับชุมชน</button>
              </center>
    
              <br>
    <footer class="page-footer">
      <span class="d-block p-2" id="color-footer-ishop">
        <center> @coppy 2018</center>
      </span>
