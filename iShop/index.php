...
<html lang="th">
  ...
  <head>
    ...
    <link ... rel="stylesheet" type="text/css" href="css/index-ishop.css?v=1010">
       ...
       ?>
        ...
        <nav class="navbar navbar-expand-lg nav-bg-ishop sticky-top">
          <div class="nav-menu-left">
             <a class="navbar-brand js-scroll-trigger text-white" href="../iShop"><h4><strong>iKingdom iShop</strong></h4></a>
           </div>
