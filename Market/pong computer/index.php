...
<html lang="th">
  ...
  <head>
    ...
    <link ... rel="stylesheet" type="text/css" href="../../css/community.css?v=1002">
    <link ... rel="stylesheet" type="text/css" href="../css/index-market.css?v=1007">
    <link ... rel="stylesheet" type="text/css" href="css/index-shop.css?v=1002">
             ...
             <a class="navbar-brand js-scroll-trigger text-white" href="../../Market"><h4><strong>iKingdom Market</strong></h4></a>
              ...
              <div class="row">
                ...
                <div class="col-8">
                  <div class="row">
                    <div class="col-3">
                      <img src="picture/1326096836.jpg" class="rounded border border-dark picture-pro-m">
                    </div>
                    <div class="col-4">
                      <?php include 'php/select_shop.php'; ?>
                     <h1><?php echo $objResult['mks_name']; ?></h1><br>
                          ...
                          <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                            ...
                            <center>
                              <div class="carousel-item active">
                                <img class="slide" src="../picture/d1.jpg" alt="First slide">
                              </div>
                              <div class="carousel-item">
                                <img class="slide" src="../picture/d2.jpg" alt="Second slide">
                              </div>
                              <div class="carousel-item">
                                <img class="slide" src="../picture/d3.jpg" alt="Third slide">
                              </div>
                            </center>
                            </div>
                ...
                <div class="col-8">
                  <nav>
                    <div class="nav nav-tabs" id="nav-tab" role="tablist">
                      ...
                      <?php 
                        include '../php/select_shopid.php';
                        if($_SESSION['UserID'] == $ShopidResult['mks_user']){ ?>
                          <a class="nav-item nav-link" id="nav-contact-tab5" data-toggle="tab" href="#nav-contact5" aria-selected="false">จัดการหลังร้าน</a>
                      <?php } ?>
                      ...
                      <div class="row">
                        <div class="col-2 " id="menu-in">
                          ...
                          <form >
                            ...
                            <br>
                            <input class="btn btn-primary" type="submit" value="ค้นหา"></center>
                          </form><hr>
                          <div class="alert alert-info" role="alert">
                            <b>หมวดหมู่สินค้า</b>
                          </div>
