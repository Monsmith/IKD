...
<html lang="th">
  ...
  <head>
    ...
    <link ... rel="stylesheet" type="text/css" href="css/index-shop.css?v=1012">
        ...
        <nav class="navbar navbar-expand-lg nav-bg-market sticky-top">
          <div class="nav-menu-left">
            ...
            <hr class="hr-m">
              ...
              <div class="container">
                <font size="5">แก้ไขสินค้า</font><button type="button" class="btn btn-outline-danger back" onclick="window.location='product_manage.php'">ย้อนกลับ</button><br>
                <hr>
                <form name="add-product" action="php/update_product.php?productid=<?php echo $_GET["productid"];?>" method="post" enctype="multipart/form-data">
                  ...
                  <div class="content">
                    <div class="form-group"><br>
                      ...
                      <select class="form-control" name="cate_pro">
                        ...
                        <?php include 'php/select_pro.php'; ?>
                    ...
                    <div class="form-group"><br>
                      ...
                      <input type="text" name="name_pro" class="form-control" value="<?php echo $productidResult['name_pro']; ?>" required>
                    </div>
                    <div class="form-group">
                        <div class="row">
                          <div class="col-4">
                            <label><h5>สี :</h5></label>
                            <input type="text" name="color_pro" class="form-control" value="<?php echo $productidResult['color_pro']; ?>">
                          </div>
                          <div class="col-4">
                            <label><h5>ขนาด :</h5></label>
                            <input type="text" name="size_pro" class="form-control" value="<?php echo $productidResult['size_pro']; ?>">
                          </div>
                          <div class="col-4">
                            <label><h5>น้ำหนัก :</h5></label>
                            <input type="text" name="weight_pro" class="form-control" value="<?php echo $productidResult['weight_pro']; ?>">
                          </div>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="row">
                          <div class="col-4">
                            ...
                            <input type="text" name="brand_pro" class="form-control" value="<?php echo $productidResult['brand_pro']; ?>">
                          </div>
                          <div class="col-4">
                            <label><h5>รุ่น :</h5></label>
                            <input type="text" name="gen_pro" class="form-control" value="<?php echo $productidResult['gen_pro']; ?>">
                          </div>
                          <div class="col-4">
                            <label><h5>สภาพ :</h5></label>
                            <input type="text" name="condition_pro" class="form-control" value="<?php echo $productidResult['condition_pro']; ?>">
                          </div>
                        </div>
                    </div>
                    <div class="form-group">
                      <label><h5><font color="red">*</font>รูปสินค้า :</h5></label>
                      <center><img  class="picture-pro-edit" src="picture/<?php echo $productidResult['picture_pro']; ?>"></center><br><br>
                ...
                <p class="collapsible"><b>&nbspรายละเอียดสินค้า</b></p>
                  <div class="content">
                    <div class="form-group">
                      <label ><h5><font color="red">*</font>รายละเอียดสินค้าแบบย่อ :</h5></label><br>
                      <label ><?php echo $productidResult['des1_pro']; ?></label>
                      <textarea class="form-control" name="des1_pro" rows="2" maxlength="150" required></textarea>
                    </div>
                    <div class="form-group">
                      <label ><h5><font color="red">*</font>รายละเอียดสินค้าแบบขยาย :</h5></label><br>
                      <label ><?php echo $productidResult['des2_pro']; ?></label>
                  ...
                  <div class="content">
                    ...
                    <div class="row">
                      <div class="col-4">
                        ...
                        <input type="number" name="price_pro" id="price" class="form-control" value="<?php echo $productidResult['price_pro']; ?>" required>
                      </div>
                      <div class="col-8">
                        <div class="row">
                        ...
                        <input type="number" name="discount" class="form-control" id="target" value="<?php echo $productidResult['discount']; ?>">
                  ...
                  <div class="content">
                    <div class="row">
                      <div class="col-6">
                        ...
                        <input type="number" name="number_pro" class="form-control" value="<?php echo $productidResult['number_pro']; ?>" required>
                      </div>
                      <div class="col-6">
                        <label><h5><font color="red">*</font>หน่วย :</h5></label>
                        <input type="text" name="unit_pro" class="form-control" value="<?php echo $productidResult['unit_pro']; ?>" required>
                      </div>
                    </div><br>
                    <div class="row">
                      <div class="col-3">
