          ...
          <div class="nav-menu-left">
            ...
            <hr class="hr-m">
              ...
              <div class="container">
                ...
                <hr>
                  <form name="add-category" action="php/update_cate.php?categoryid=<?php echo $_GET["categoryid"];?>" method="post" enctype="multipart/form-data">
                    <?php include 'php/select_cate.php'; ?>
                  <p class="collapsible"><b>&nbspข้อมูลหมวดหมู่</b></p>
                  <div class="content">
                    
                    <div class="form-group"><br>
                      <label><h5>หมวดหมู่ :</h5></label>
                      <input type="text" name="category" class="form-control" value="<?php echo $cateResult['category_name']; ?>">
                    </div>
                    <div class="form-group">
                      <label><h5>รูปหมวดหมู่ :</h5></label><br>
                      <center><img  class="picture-pro-edit" src="picture/<?php echo $cateResult['category_picture']; ?>"></center><br><br>
